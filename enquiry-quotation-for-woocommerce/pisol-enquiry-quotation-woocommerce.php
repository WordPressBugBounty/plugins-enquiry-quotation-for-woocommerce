...
add_action('after_plugin_row_enquiry-quotation-for-woocommerce-pro/pisol-enquiry-quotation-woocommerce.php', function ($plugin_file, $plugin_data) {
    $url = wp_nonce_url(
        self_admin_url( 'plugins.php?action=deactivate&plugin=enquiry-quotation-for-woocommerce/pisol-enquiry-quotation-woocommerce.php' ),
        'deactivate-plugin_enquiry-quotation-for-woocommerce/pisol-enquiry-quotation-woocommerce.php'
    );
    ?>
 ...
 * Start at version 2.2.34.39 and use SemVer - https://semver.org
 * Rename this for your plugin and update it as you release new versions.
 */
define( 'PISOL_ENQUIRY_QUOTATION_WOOCOMMERCE_VERSION', '2.2.34.39' );
